...
\resumeHeadingSkillStart
  ...
  \resumeSubItem{Cloud Technologies:}
    {AWS (S3, EC2), Google Cloud Platform, Microsoft Azure}
  \resumeSubItem{DevOps \& Version Control:}
    {Git, GitHub, Docker, Jenkins, CI/CD basics}
  \resumeSubItem{Specialized Area:}
    {Machine Learning, Deep Learning, Explainable AI, Time Series Analysis}
  \resumeSubItem{Mathematical \& Statistical Tools:}
    {MATLAB, R, MATLAB, Excel, Statistical Analysis, Probability}
  \resumeSubItem{Other Tools \& Technologies:}
    {Jupyter Notebook, VS Code, Postman, Tableau, Power BI}
...
\resumeSubheading
  {TULIP Lab[\href{https://www.tulip.academy}{\faIcon{globe}}]}{Virtual}
  {Research Intern}{Jun 2024 -- Sept 2024}
  \resumeItemListStart
    \item Conducted time series anomaly detection using PyOD, DeepANT, STUMPY, and scikit-learn under the guidance of Prof. Gang Li at TULIP Lab, Deakin University.
...
{B.Tech in Computer Science and Engineering}{Aug 2021 -- Present}
\resumeItemListStart
\item Project: Permutation Effects in Multilingual Summarization using Transformers via Ordered Evaluation
\item GPA: 8.82/10 
...
\resumeProject
  {Multi-Model Disease Classification and Prediction}
  {Tools: Python, sklearn, seaborn, matplotlib, Jupyter Notebook}
  {2024}
  {{}[\href{https://github.com/your-username/multi-disease-classification}{\textcolor{darkblue}{\faGithub}}]}
\resumeItemListStart
  \item Developed ML models to classify Breast Cancer, Diabetes, Heart Disease, Lung Cancer, and Parkinson's Disease.
  \item Achieved ~96\% accuracy through efficient preprocessing and model tuning techniques.
\resumeItemListEnd
...
\section{\textbf{Leadership and Achievements}}
\vspace{-0.4mm}
\resumeSubHeadingListStart
...
\resumeItemListStart
  \item Secured institutional funding to present research at a national conference and file a patent.
